...
(1, 'hyundai', 'altima', 'BMW Serie 8 Coupé', NULL, NULL, 878, 2, 'Blue', '1977', 4, 2, 940, 'manual', 465000, 'electrica', '$', 5.5, 'v8', 'rwd', 'Russia', 314000, 'wagon', 'Yukon', 79.62, 6.96, '3208-VQJ', 'ECO', '2014-03-03 14:04:08', '2024-05-10 08:33:02', '¡He!¡oh! Arriba, chuta, la victoria es tuya Inazumaa campeón(¡he!) Aunque nos cueste, levantarnos llenos de barro una vez más (avanza) siempre mirando hacia delante preparados para entrenar Sé un contendiente amistoso (juega) juega y no temas el fracaso, (entrena) convirtamos en goles tus ganas de triunfar Los sueños nacen con esfuerzo y dedicación jugando en equipo, llegará nuestra ocasión (¡inazuma!) los astros del balón, directos a la final tendrá nuestro equipo el liderazgo, gol a gol ¡he! Arriba, chuta, la victoria es tuya ruge el estadio recordando al Inazuma Arriba, chuta, la victoria es tuya los goles se suceden, raimon sigue y suma arriba, chuta, la victoria es tuya Inazuma eleven es. Inazuma (¡ánimo raimon!) te hará un campeón', 2),
(2, 'Chevrolet', 'Corvette', 'Chevrolet Bolt EV Corvette', NULL, NULL, 83, 0, 'white', '1990', 2, 3, 694, 'manual', 896779, 'hybrid', '£', 3.4, 'I4', 'RWD', 'United Kingdom', 4389346, 'SUV', 'British Columbia', 59.04, 5.79, '8745-PGT', 'ECO', '2013-10-20 14:24:17', NULL, 'while one house sleeps loudly one book reads', 2),
(4, ' Nissan ', ' Golf ', ' Nissan Golfá', NULL, NULL, 16, 0, ' Purple ', '2015', 3, 2, 71, 'Automatic ', 9000, ' Electric ', ' £ ', 10, ' I5 ', 'RWD ', 'Norway', 3583, ' Hatchback ', 'Nova Scotia', 93.09, 6.42, '0806-WMR', 'B', '2011-11-19 01:13:53', '2024-05-10 07:30:06', ' whenever one house fly quickly one car ate slowly ', 1),
...
(6, 'Honda', 'S60', 'Honda S60', '2024-02-22 00:38:09', NULL, 11, 0, 'red', '1976', 5, 5, 351, 'automatic', 1208320, 'electric', '€', 8.4, 'I5', 'RWD', 'Japan', 1004933, 'Convertible', 'Basque Country', 102.76, 9.12, '2356-IQV', 'C', '2022-09-29 21:26:41', '2024-02-22 00:38:09', 'while a book shines brightly the cat ate', 1),
(7, 'Chevrolet', 'Civic', 'Chevrolet Civic', '2024-02-22 00:38:09', NULL, 2, 0, 'green', '1926', 5, 5, 1185, 'manual', 60920, 'petrol', '€', 3.3, 'I3', 'RWD', 'France', 3689858, 'SUV', 'Valencia', 45.93, 9.03, '9198-NCI', 'B', '2017-08-13 05:08:07', '2024-02-22 00:38:09', 'when the car ate one friend shines slowly and a sun barks softly', 1),
...
(23, 'BMW', '4 Series Gran Coupe', 'BMW 4 Series Gran Coupe', NULL, NULL, 1, 0, 'red', '2020', 5, 2, 0, 'manual', 11000, 'gasoline', '€', NULL, NULL, NULL, NULL, 33000, NULL, 'Nunavut', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2),
(24, 'Hyundai', 'E-Class', 'Hyundai E-Class', '2024-03-11 01:48:33', NULL, 1, 0, 'red', '1998', 4, 4, 144, 'manual', 1223582, 'electric', '$', 6.3, 'W12', 'FWD', 'Spain', 4994315, 'Sedan', 'Madrid', 44.36, 7.33, '4723-WWL', 'B', '2014-07-20 00:44:34', '2024-03-11 01:48:33', 'unless one sandwich shines one dog barks', 1),
...
(23, 'Jaime', 'Rosello', 'jaumerosello_', 1, '2004-08-02 20:09:07', 'Spain', 'Valencia', '       Soy el verdadero admin       ', '613e710a-8f2d-43e7-a9a2-598de4f3c205.jpg', '55a3d608-8de3-42cd-b7c0-c05dbc84e883.jpg', 0, '601447829', 'jarogos14@gmail.com', 'afb47e00531153e93808589e43d02c11f6398c5bc877f7924cebca8211c8dd18', 1, '2024-05-02 18:07:33', '2024-05-02 18:07:33', 0, 1, 0);
...
--
ALTER TABLE `favorites`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=529;
