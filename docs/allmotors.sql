...
(1, 'hyundai', 'penelope', 'BMW Serie 8 Coupé', NULL, NULL, 2418, 2, '#000080', '2022', 5, 3, 940, 'automatic', 465000, 'gasoline', '$', 5.5, 'v8', 'AWD', 'Russia', 314000, 'coupe', 'Yukon', 79.62, 6.96, '3208-VQJ', 'ECO', '2014-03-03 14:04:08', '2024-05-17 07:51:16', 'Ahora escucha la historia de mi vida Y de cómo el destino cambió mi movida Sin comerlo ni beberlo llegué a ser El chuleta de un barrio llamado Bel Air Al oeste en Filadelfia, crecía y vivía Sin hacer mucho caso a la policía Jugaba al basket sin cansarme demasiado Porque por las noches me sacaba el graduado Cierto día jugando al basket con amigos Unos tipos del barrio me metieron en un lío Y mi madre me decía una y otra vez ¡Con tu tío y con tu tía irás a Bel Air!', 23),
(2, 'chevrolet', 'corvette', 'Chevrolet Bolt EV Corvette', NULL, NULL, 88, 0, '#1F2937', '1990', 2, 3, 694, 'manual', 897000, 'hybrid', '$', 3.4, 'i4', 'rwd', 'United Kingdom', 17300, 'suv', 'British Columbia', 59.04, 5.79, '8745-PGT', 'ECO', '2013-10-20 14:24:17', '2024-05-14 16:35:46', 'while one house sleeps loudly one book reads', 3),
(4, 'nissan', 'golf', 'Nissan Golfá', NULL, NULL, 17, 0, '#800080', '2015', 3, 2, 71, 'automatic', 9000, 'electric', ' £ ', 10, 'i5', 'rwd', 'Norway', 3583, 'hatchback', 'Nova Scotia', 93.09, 6.42, '0806-WMR', 'B', '2011-11-19 01:13:53', '2024-05-13 16:35:21', 'whenever one house fly quickly one car ate slowly', 4),
(5, 'chevrolet', 'f-150', 'Chevrolet F-150', '2024-02-22 00:38:09', NULL, 11, 0, '#FFC107', '1961', 3, 4, 1257, 'manual', 318000, 'petrol', '£', 3.7, 'v12', 'fwd', 'South Korea', 1265, 'truck', 'Newfoundland and Labrador', 64.38, 9.12, '8863-SLC', 'C', '2023-07-24 05:47:51', '2024-05-13 16:22:27', 'before one car shines brightly the sandwich barks', 2),
...
(7, 'chevrolet', 'civic', 'Chevrolet Civic', '2024-02-22 00:38:09', NULL, 2, 0, 'green', '1926', 5, 5, 1185, 'manual', 61000, 'petrol', '€', 3.3, 'i3', 'rwd', 'France', 3689, 'suv', 'Valencia', 45.93, 9.03, '9198-NCI', 'B', '2017-08-13 05:08:07', '2024-05-13 16:35:35', 'when the car ate one friend shines slowly and a sun barks softly', 5),
...
(34, 'mercedes-benz', 'model 3', 'Mercedes-Benz Model 3', '2024-03-11 01:48:33', NULL, 13, 0, '#00FFFF', '2015', 3, 3, 398, 'manual', 920000, 'petrol', '¥', 6.7, 'i4', 'fwd', 'Canada', 2809, 'convertible', 'Northwest Territories', 31.66, 9.02, '9192-TBT', '0', '2017-01-19 09:34:33', '2024-05-13 16:07:13', 'since the car is softly the birds ate', 2),
...
(1208, 'image7.jpg', 74),
(1209, 'image10.jpg', 74),
(1210, 'b6e21c3d-5432-4313-893f-8d092e5d00b3.jpg', 1);
...
--
ALTER TABLE `favorites`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=533;

--
-- AUTO_INCREMENT for table `images`
--
ALTER TABLE `images`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1211;
